...
const Header = () => {
  ...
  return (
    <div className="sticky  top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 dark:bg-black bg-black">
      {loading && <Loader />}
      ...
      <div className="group flex items-center">
        <div className="border border-[#303030] flex h-8 items-center md:h-10 md:ml-10 md:pl-5 rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
      ...
      <div className="flex items-center justify-center ">
        ...
        <div className=" flex h-8 w-8 overflow-hidden rounded-full md:ml-4 items-center">
          <img
